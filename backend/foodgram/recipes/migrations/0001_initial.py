    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='recipes/images/dish.png', upload_to='recipes/images/', verbose_name='Изображение')),
                ('text', models.TextField(verbose_name='Описание')),
                ('cooking_time', models.PositiveIntegerField(help_text='Время приготовления должно быть указано в минутах. Это поле не может иметь отрицительные и нулевое значения.', verbose_name='Время приготовления в мин.')),
            ],
            options={
                'verbose_name': 'рецепт',
